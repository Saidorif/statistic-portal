...
class CreateStatisticInternationalCargosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statistic_international_cargos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('statistic_international_cargos');
    }
}
