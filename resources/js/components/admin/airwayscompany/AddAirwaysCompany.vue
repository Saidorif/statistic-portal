		...
		<div class="card">
		  	<div class="card-header">
			    <h4 class="title_user">
				    ...
				    Добавить Название авиакомпании
				</h4>
...
<script>
	...
	export default{
		...
		computed:{
			...mapGetters('airwayscompany',['getMassage'])
		},
		mounted(){
			this.laoding = false
		},
		methods:{
			...mapActions('airwayscompany',['actionAddAirwaysCompany']),
			isRequired(input){
			...
			async saveAirwaysCompany(){
		    	if (this.form.name != ''){
					this.laoding = true
					await this.actionAddAirwaysCompany(this.form)
