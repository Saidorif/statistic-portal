		  		...
		  		<form>
					<div class="row">
					  ...
					  <div class="form-group col-lg-12 d-flex justify-content-end">
					  	<button type="button" class="btn_blue_icon" @click.prevent="openModal" v-if="form.status != 'accepted'">
					  		<i class="fas fa-minus-circle"></i>
						  	Отказать
						</button>
					  	<button type="button" class="btn_green" @click.prevent="acceptFakt" v-if="form.status != 'accepted'">
		  	...
		  	<div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-footer">
			        <button type="button" class="btn_green" @click.prevent="rejectFakt">
				        Отправить
