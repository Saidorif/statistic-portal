...
<script>
	...
	export default{
		...
		computed:{
			...mapGetters('statisticinternationalcargo',['getMassage']),
		...
		methods:{
			...mapActions('statisticinternationalcargo',['actionAddStatisticInternationalCargo']),
			...
			async saveStatistic(){
		    	if (this.form.type != '' && this.form.year != ''){
					this.laoding = true
					await this.actionAddStatisticInternationalCargo(this.form)
