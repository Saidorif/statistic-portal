	...
	<div class="add_statistic">
		...
		<div class="card">
		  	<div class="card-header">
				...
				<router-link class="btn_black" to="/crm/statisticinternationalmoney"><span class="peIcon fas fa-arrow-left"></span> Назад</router-link>
		  	</div>
		  	<div class="card-body">
...
<script>
	...
	export default{
		...
		computed:{
			...mapGetters('statisticinternationalmoney',['getMassage']),
		...
		methods:{
			...mapActions('statisticinternationalmoney',['actionAddStatisticInternationalMoney']),
			...
			async saveStatistic(){
		    	if (this.form.year != ''){
					this.laoding = true
					await this.actionAddStatisticInternationalMoney(this.form)
