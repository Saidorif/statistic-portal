	...
	<div class="fakt">
		...
		<div class="card">
		  	<div class="card-header">
                ...
                <div>
                    <router-link class="btn_green mr-1" :to='`/crm/expec-mod/fakt/${$route.params.faktregionId}/add?expectId=${$route.query.expectId}`'>
                        <i class="fas fa-plus"></i>
                        Добавить
                    </router-link>
                    <router-link class="btn_black" :to='`/crm/expec-mod/${$route.query.expectId}`'>
				...
				<table class="table table-bordered text-center table-hover table-striped">
					...
					<tbody>
						<tr v-for="(reg,index) in getFakts.data">
							...
							<td>
								<router-link tag="button" class="btn_blue mr-1" :to='`/crm/expec-mod/fakt/${$route.params.faktregionId}/edit/${reg.id}?expectId=${$route.query.expectId}`'>
									<i class="pe_icon fas fa-pen editColor"></i>
								</router-link>
								<router-link tag="button" class="btn_blue mr-1" :to='`/crm/expec-mod/fakt/${$route.params.faktregionId}/show/${reg.id}?expectId=${$route.query.expectId}`'>
