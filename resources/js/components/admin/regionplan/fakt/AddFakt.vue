...
<script>
	...
	export default{
		...
		methods:{
			...
			async saveFakt(){
		    	if (this.form.bus_id != '' && this.form.capacity != '' && this.form.bank_credit != '' && this.form.auto_price_sum != '' && this.form.auto_price_dollar != '' && this.form.auto_price_euro != '' && this.form.purchase_date != '' && this.form.bank_contract != '' && this.form.zavod_contract != '' && this.form.registr_cerf != ''){
					this.laoding = true
					this.form['expect_id']=Number(this.$route.params.faktregionId)
					await this.actionAddFakt(this.form)
